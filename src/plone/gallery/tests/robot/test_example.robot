...
#
#  $ bin/test -s plone.gallery -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src plone.gallery.testing.PLONE_GALLERY_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/plone/gallery/tests/robot/test_example.robot
#
